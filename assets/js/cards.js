...
async function renderDetail(entry, kind) {
  ...
  document.querySelector("main").innerHTML = `<a class="back-link" href="${kind === "til" ? "til.html" : "blog.html"}">&larr; Back to ${backLabel}</a><article class="post-page">${item.articleHtml}</article>`;
}
